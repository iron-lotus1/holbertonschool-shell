...
* [Where am I](./0-current_working_directory) pwd - print name of current/working directory

SYNOPSIS
       pwd [OPTION]...

* [What's in there](./1-listit) ls - list directory contents
...
* [Welcome](./6-firstdirectory) mkdir - make directories
...
* [File type](./12-file_type) file [FILE...] = Determine type of FILEs
